...
@Component({
  selector: 'app-allorderreport',
  templateUrl: './allorderreport.component.html',
  styleUrls: ['./allorderreport.component.scss']
})
export class AllorderreportComponent implements OnInit {
